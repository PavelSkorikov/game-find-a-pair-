$(function () {
    ...
    function updateTime() {
          //получаем количество милисекунд времени игры, отнимая от текущих секунд начальные на момент старта
    ...
    function game(){
        ...
        var result = [];
        //переменная для утранения проблемы быстрых кликов
		var click = false;
        ...
        $('.item').bind('click', function(){
			...
			if(!click){
				...
				// если ее еще нет среди открытых ячеек
				if((flag == 0) && (!result.includes(num_id))){
